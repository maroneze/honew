...
[![GitHub](https://img.shields.io/github/license/maroneze/honew?color=red)](https://github.com/maroneze/honew/blob/main/LICENSE)
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/maroneze/honew/python_check.yml?branch=main&label=checks)](https://github.com/maroneze/honew/actions/workflows/python_check.yml)
[![Buy Me a Coffee](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-donate-orange.svg)](https://www.buymeacoffee.com/andre0512)  
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/maroneze/honew?color=green)](https://github.com/maroneze/honew/releases/latest)
[![GitHub all releases](https://img.shields.io/github/downloads/maroneze/honew/latest/total?color=blue&label=downloads)](https://tooomm.github.io/github-release-stats/?username=Andre0512&repository=hon)
[![GitHub all releases](https://img.shields.io/github/downloads/maroneze/honew/total?color=blue&label=total%20downloads)](https://tooomm.github.io/github-release-stats/?username=Andre0512&repository=hon)

---

Home Assistant integration for [Haier's mobile app hOn](https://hon-smarthome.com/) based on [pyhOn](https://github.com/maroneze/pyhOnew).

---

[![Supported Languages](https://img.shields.io/badge/Languages-19-royalblue)](https://github.com/maroneze/honew#supported-languages)
[![Supported Appliances](https://img.shields.io/badge/Appliances-11-forestgreen)](https://github.com/maroneze/honew#supported-appliances)
[![Supported Models](https://img.shields.io/badge/Models-127-yellowgreen)](https://github.com/maroneze/honew#supported-appliances)
[![Supported Entities](https://img.shields.io/badge/Entities-317-crimson)](https://github.com/maroneze/honew#supported-appliances)  
...
**Method 3:** Manually copy `hon` folder from [latest release](https://github.com/maroneze/honew/releases/latest) to `config/custom_components` folder.
...
| Please add your appliances data to our [honew-test-data collection](https://github.com/maroneze/honew-test-data). <br/>This helps us to develop new features and not to break compatibility in newer versions. |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
1. Install [pyhOn](https://github.com/maroneze/pyhOnew)
   ```commandline
    $ pip install pyhOn
    ```
...
4. Add the keys of the attributes you'd like to have as `EntityDescription` into this Repository  
   _Example: Add pause button_
    ...
    BUTTONS: dict[str, tuple[ButtonEntityDescription, ...]] = {
        ...
        ...
    ```
5. Create a [pull request](https://github.com/maroneze/honew/pulls)

#### Tips and Tricks
- If you want to have some states humanreadable, have a look at the `translation_key` parameter of the `EntityDescription`.
- If you need to implement some more logic, create a pull request to the underlying library. There we collect special requirements in the `appliances` directory.
- Use [pyhOn's translate command](https://github.com/maroneze/pyhOnew#translation) to read out the official translations
